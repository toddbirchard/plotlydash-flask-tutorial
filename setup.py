...
setup(
    ...
    name='plotly_flask_tutorial',  # Required
    ...
    description='Tutorial for embedding a Plotly Dash app inside a Flask app.',  # Optional
    ...
    url='https://github.com/toddbirchard/plotlydash-flask-tutorial',  # Optional
